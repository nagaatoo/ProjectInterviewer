...
public class VidoeComponent extends Div {
    ...
    private void initCamera(Div videoDiv) {
        videoDiv.setId("cameraDiv");
        UI
                .getCurrent()
                .getPage()
                .executeJs(
                        """
                                let localVideo = document.createElement('video');
                                    ...
                                    document.getElementById("cameraDiv").appendChild(localVideo);
    ...
    private void initVideo(Div videoDiv) {
        videoDiv.setId("videoDiv");
        UI
                .getCurrent()
                .getPage()
                .executeJs(
